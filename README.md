...
To play the game, only click new images. 

If you click the same image twice, your score and the game resets.

If you'd like to view this project, check out the documentation below provided by [Create React App](https://github.com/facebook/create-react-app).
